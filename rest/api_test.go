...
func TestByBit_CreateOrderV2_Market_ETHUSD(t *testing.T) {
	b := newByBit()
	symbol := "ETHUSD"
	side := "Buy"
	orderType := "Market"
...
func TestByBit_CreateOrderV2_Market_BTCUSDT(t *testing.T) {
	b := newByBit()
	symbol := "BTCUSDT"
	side := "Buy"
	orderType := "Market"
...
func TestByBit_CreateOrder_Limit_Buy_BTCUSD(t *testing.T) {
	b := newByBit()
	symbol := "BTCUSD"
	side := "Buy" // Buy Sell
	orderType := "Limit"
...
func TestByBit_CreateOrder_Limit_Sell_BTCUSD(t *testing.T) {
	b := newByBit()
	symbol := "BTCUSD"
	side := "Sell" // Buy Sell
	orderType := "Limit"
